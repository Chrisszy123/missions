...
import styles from "@/components/Catalog/Card/Card.module.sass";
        ...
        <div className={styles.user}>
            ...
            <div className={styles.foot}>
                <div className={styles.box}>
                    ...
                    <div className={styles.price} style={{fontSize: "10px", textOverflow: 'ellipsis'}}>{item.rewards[0]}</div>
                </div>
                <div className={styles.box}>
                    <div className={styles.text}>Frequency</div>
                    <div className={styles.price} style={{fontSize: "10px", textOverflow: 'ellipsis'}}>{item.recurrence}</div>
                </div>
            </div>
        </a>
    </Link>
